    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-3">
                ...
                <img src="{'footer_payments' | config}" alt="Способы оплаты" class="fImg">
                <span class="fZag">Наши партнеры</span>
                <img src="{'footer_clients' | config}" alt="Наши партнеры" class="fImg">
...
<div class="foot">
    <div class="container">
        <div class="row">
            ...
            <div class="col-8">
                <ul class="policy"> <li><a href="{73 | url}">Пользовательское соглашение</a></li> <li><a href="{72 | url}">Политика конфиденциальности</a></li> <li><a href="{71 | url}">Политика обработки персональных данных</a></li> </ul>
            </div>
        </div>
    </div>
</div>